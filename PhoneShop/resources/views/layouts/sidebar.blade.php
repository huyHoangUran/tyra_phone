<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div
        ...
        <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 364px;"></div>
        ...
        <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
            <div class="os-scrollbar-track">
                <div class="os-scrollbar-handle" style="height: 26.858%; transform: translate(0px, 26.5594px);"></div>
            </div>
        </div>
